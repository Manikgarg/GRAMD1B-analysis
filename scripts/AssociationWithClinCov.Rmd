...
if (tissue=="Skin") {
  ...
  combinations<-c("", 
                ...
                "+treatment",
                "+as.numeric(Nclass)",
                "+Sex+Age+as.character(Stage)+ECOG+treatment+as.numeric(Nclass)",
                "+Sex+Age+as.character(Stage)+ECOG+treatment+as.numeric(Nclass)+ClarkScore")}else{
                  combinations<-c("", 
                "+Sex",
                "+Age",
                "+as.character(Stage)",
...
if (tissue=="Skin") {
  ...
  os$Group<- factor(c("GRAMD1B", 
             ...
             "GRAMD1B+Treatment", 
             "GRAMD1B+Nclass",
             "GRAMD1B+Sex+Age+Stage+\nECOG+treatment+Nclass"), levels=c("GRAMD1B", 
             "GRAMD1B+Sex", 
             "GRAMD1B+Age", 
             "GRAMD1B+Stage", 
             "GRAMD1B+ECOG", 
...
ggsave(paste("../results/survival/AVAST-M_",tissue,"_OS_PFS_ForestPlots.pdf", sep=""), device = "pdf", width = 10, units = "cm", height=12)


#Save the values
write.table(os, paste("../results/survival/AVAST-M_",tissue,"_OS_multivariate.tsv", sep=""), sep="\t", col.names = T, row.names = F)
write.table(pfs, paste("../results/survival/AVAST-M_",tissue,"_PFS_multivariate.tsv", sep=""), sep="\t", col.names = T, row.names = F)
```
